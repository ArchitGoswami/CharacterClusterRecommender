...
def get_list():
    ...
    with open('/Users/alisongunzler/Desktop/FP_IWRA/WAandIRFinalProject/possible_word_vars/combo_in_pitch_rew.txt', 'r') as f:
        vocab = f.readlines()
...
def cluster_docs(docs, vocab, output_dir="created_clusters_given_ex_cond"):
