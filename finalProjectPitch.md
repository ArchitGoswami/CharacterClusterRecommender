...
**Processing Pipeline:**
1. Build user preference vector (centroid of selected characters)
2. Find similar characters not in user's watched shows
3. Rank shows by number of similar characters plus similarity scores
...
2. **Top 300 Sitcom Filter**
   - Apply relevance filtering

3. **Character Trait Vector Extraction**
...
1. Get 5 characters from user
2. Match against character database
